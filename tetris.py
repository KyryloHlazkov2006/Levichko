...
def showText(text):
    ...
    pressKeySurf, pressKeyRect = txtObjects('Натисніть будь-яку клавішу, щоб продовжити', basic_font, title_color)
...
def drawInfo(points, level):
    pointsSurf = basic_font.render(f'Бали: {points}', True, txt_color)
...
def drawnextFig(fig):  # превью следующей фигуры
    nextSurf = basic_font.render('Наступна:', True, txt_color)
